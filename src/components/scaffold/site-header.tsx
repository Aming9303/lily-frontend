    ...
    <header className="border-b border-[var(--color-line)] bg-white/90">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Global" className="flex flex-wrap gap-2 text-sm">
          <Link
            className="motion-link rounded-full border border-[var(--color-line)] px-4 py-2 hover:border-[var(--color-accent)]"
          ...
          <Link
            className="motion-link rounded-full bg-[var(--color-ink)] px-4 py-2 text-white hover:opacity-90"
